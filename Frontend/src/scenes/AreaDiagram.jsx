        ...
        <Container className="min-vh-100 pb-5" style={{marginTop: 100}}>
            ...
            <Row style={{marginTop: 10,
                ...
                <Form onSubmit={submitHandler}>
                        <Button style={{marginTop: 10, marginLeft: 5, background: "#0B8745", borderColor: "#0B8745"}} onClick={() => setSelection(1)}>Amount of Trips by trip distance and Weekday</Button>
                        <Button style={{marginTop: 10, marginLeft: 5, background: "#0B8745", borderColor: "#0B8745"}} onClick={() => setSelection(2)}>Amount of Trips by Weekday</Button>
                    </Form>
